...
chmod 644 "/home/student/podman-compose.yml"

# Execute podman-compose up -d using the created file
sudo su - student -c "cd /home/student/ && podman-compose up -d" >/dev/null 2>&1
...
sudo su - student -c "podman exec db1 rm -f /home/ansible_user/.ssh/*" >/dev/null 2>&1
...
# Manage keys (db1)
sudo su - student -c "podman cp /tmp/id_rsa.pub db1:/home/ansible_user/.ssh/authorized_keys" >/dev/null 2>&1
sudo su - student -c "podman exec db1 bash chmod 600 /home/ansible_user/.ssh/authorized_keys" >/dev/null 2>&1
sudo su - student -c "podman exec db1 bash chown ansible_user:ansible_user /home/ansible_user/.ssh/authorized_keys" >/dev/null 2>&1
