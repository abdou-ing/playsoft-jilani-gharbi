...
case "$lang" in
  en)
    ...
    inst1="Write the playbook — define all <span class=\"bold-green-text\">iptables</span> rules, REJECT must be the last rule:"
  ...
  fr)
    ...
    inst1="Écrivez le playbook — définissez toutes les règles <span class=\"bold-green-text\">iptables</span>, REJECT doit être la dernière règle :"
